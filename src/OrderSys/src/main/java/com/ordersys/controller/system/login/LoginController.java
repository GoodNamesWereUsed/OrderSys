package com.ordersys.controller.system.login;

import com.ordersys.entity.system.Menu;
import com.ordersys.entity.system.Role;
import com.ordersys.entity.system.User;
import com.ordersys.service.system.appuser.AppuserManager;
import com.ordersys.service.system.buttonrights.ButtonrightsManager;
import com.ordersys.service.system.fhbutton.FhbuttonManager;
import com.ordersys.service.system.menu.MenuManager;
import com.ordersys.service.system.role.RoleManager;
...
public class LoginController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/login_toLoginDisplay")
	public ModelAndView toLoginDisplay() throws Exception {
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("SYSNAME", Tools.readTxtFile(Const.SYSNAME)); //读取系统名称
	 ...
	 * @return
	 */
	@RequestMapping(value = "/maindisplay/{changeMenu}")
	@SuppressWarnings("unchecked")
	public ModelAndView login_display(@PathVariable("changeMenu") String changeMenu) {
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			...
			if (user != null) {
				 ...
				 * @Author huangMP
				 */
				String userRoleName = role.getROLE_NAME();
				if ("管理人员".equals(userRoleName)) {
					mv.setViewName("display/index");
				} else if ("后厨人员".equals(userRoleName)) {
					mv.setViewName("display/ketchen");
				} else if ("点餐人员".equals(userRoleName)) {
					mv.setViewName("display/index");
				} else {
					mv.setViewName("system/index/login");
				}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/logoutDisplay")
