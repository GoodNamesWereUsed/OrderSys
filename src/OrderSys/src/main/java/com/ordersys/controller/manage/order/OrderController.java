package com.ordersys.controller.manage.order;
...
public class OrderController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("manage/order/order_list");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).get("ORDER_STATUS").toString());	//2
			vpd.put("var3", varOList.get(i).get("PERSON_NUM").toString());	//3
			vpd.put("var4", varOList.get(i).getString("WAITER_ID"));	//4
			vpd.put("var5", varOList.get(i).getString("DISCOUNT"));	//5
			vpd.put("var6", varOList.get(i).getString("ORDER_PRICE"));	//6
